...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-i9p6zha.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-i9p6zha.containers.anotherwebservice.com/
...
```
git clone git@github.com:jamilsoft-bot/container-i9p6zha.git
cd container-i9p6zha
```
...
```
docker attach container-i9p6zha
```
